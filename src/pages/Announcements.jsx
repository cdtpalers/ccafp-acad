          ...
          content: `
            <div style="overflow-x: auto; margin-top: 1rem;">
              <table class="data-table" style="width: 100%; border-collapse: collapse; text-align: center;">
                ...
                <tbody>
                  <tr><td data-label="Period" style="padding: 1rem; border: 1px solid var(--surface-border); font-weight: bold;">1st Period</td><td data-label="Monday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec I</td><td data-label="Tuesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec J</td><td data-label="Wednesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec J</td><td data-label="Thursday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec C</td><td data-label="Friday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec I</td></tr>
                  <tr><td data-label="Period" style="padding: 1rem; border: 1px solid var(--surface-border); font-weight: bold;">2nd Period</td><td data-label="Monday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec G</td><td data-label="Tuesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec H</td><td data-label="Wednesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec H</td><td data-label="Thursday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec E</td><td data-label="Friday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec G</td></tr>
                  <tr><td data-label="Period" style="padding: 1rem; border: 1px solid var(--surface-border); font-weight: bold;">3rd Period</td><td data-label="Monday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec D</td><td data-label="Tuesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec A</td><td data-label="Wednesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec E</td><td data-label="Thursday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec B</td><td data-label="Friday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec F</td></tr>
                  <tr><td data-label="Period" style="padding: 1rem; border: 1px solid var(--surface-border); font-weight: bold;">4th Period</td><td data-label="Monday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec A</td><td data-label="Tuesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec K</td><td data-label="Wednesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec B</td><td data-label="Thursday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec L</td><td data-label="Friday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec C</td></tr>
                  <tr><td data-label="Period" style="padding: 1rem; border: 1px solid var(--surface-border); font-weight: bold;">5th Period</td><td data-label="Monday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec K</td><td data-label="Tuesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec D</td><td data-label="Wednesday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec L</td><td data-label="Thursday" style="padding: 1rem; border: 1px solid var(--surface-border);">Sec F</td><td data-label="Friday" style="padding: 1rem; border: 1px solid var(--surface-border);">Acad Council</td></tr>
                </tbody>
              </table>
            </div>
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        // Render Kanban Board
        return (
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'flex-start', paddingBottom: '1rem' }}>
            {columns.map(col => {
               const colAnns = categorizedAnns[col];
               if (colAnns.length === 0 && (searchTerm || typeFilter !== 'All Types') && col === 'Other') return null;

               const isInfo = col === 'Info';

               return (
                 <div key={col} style={{ display: 'flex', flexDirection: 'column', gap: '1rem', flex: isInfo ? '2 1 400px' : '1 1 250px' }}>
      ...
      {selectedAnn && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', WebkitBackdropFilter: 'blur(4px)', backdropFilter: 'blur(4px)', zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }} onClick={() => setSelectedAnn(null)}>
          <div className="glass-panel modal-inner" style={{ background: 'var(--bg-color)', width: '100%', maxWidth: '900px', maxHeight: '90vh', overflowY: 'auto', position: 'relative', padding: '2.5rem', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-lg)' }} onClick={e => e.stopPropagation()}>
