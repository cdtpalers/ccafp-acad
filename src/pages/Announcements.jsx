          ...
          content: `
            <div style="overflow-x: auto; margin-top: 1rem;">
              <table class="data-table" style="width: 100%; border-collapse: collapse; text-align: center;">
                ...
                <tbody>
                  <tr><td style="padding: 1rem; border: 1px solid var(--surface-border); font-weight: bold;">1st Period</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec F</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec B</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec F</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec A</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec D</td></tr>
                  ...
                  <tr><td style="padding: 1rem; border: 1px solid var(--surface-border); font-weight: bold;">4th Period</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec I</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec J</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec I</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec J</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec B</td></tr>
                  <tr><td style="padding: 1rem; border: 1px solid var(--surface-border); font-weight: bold;">5th Period</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec G</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec L</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec G</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Sec L</td><td style="padding: 1rem; border: 1px solid var(--surface-border);">Acad Council</td></tr>
                </tbody>
              </table>
            </div>
